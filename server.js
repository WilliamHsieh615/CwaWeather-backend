...
//     // 直接在 URL 加上 Key
//     const response = await axios.get(`https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=${CWA_API_KEY}`);
...
//       const weatherData = { city: loc.locationName, forecasts: [] };
...
//             case "PoP": forecast.rain = val.parameterName + "%"; break;
...
//             case "WS": forecast.windSpeed = `${val.parameterName || "-"} ${val.parameterUnit || ""}`; break;
//           }
//         });
